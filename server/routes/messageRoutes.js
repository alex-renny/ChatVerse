...
import {sendMessage,getMessages,deleteMessage,markAsSeen,reactToMessage,togglePinMessage,unpinMessage,clearChat,} from "../controllers/messageController.js";
...
router.delete("/clear/:receiverId", protect, clearChat); // Move this here
